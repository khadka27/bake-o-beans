      ...
      <section className="relative h-[50vh] sm:h-[60vh] flex items-center justify-center overflow-hidden">
        <div className="absolute inset-0 z-0">
          <Image
            ...
            alt="Bake O Beans Café Menu - Simalchaur Pokhara"
            fill
        ...
        >
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-serif font-bold text-paper-50 mb-4">
            Bake O Beans Café Menu
          </h1>
          <p className="text-lg sm:text-xl text-paper-200 max-w-2xl mx-auto">
            Discover our carefully crafted selection of handcrafted coffee,
            fresh bakery, and delicious food in Simalchaur, Pokhara.
          </p>
        </motion.div>
      </section>
      ...
      {menuSections.map((section, sectionIndex) => (
        ...
        >
          ...
          <div className="absolute inset-0 z-0">
            <Image
              src={section.bgImage}
              alt={`${section.title} - Bake O Beans Café Pokhara`}
              fill
              className="object-cover"
              sizes="100vw"
            />
